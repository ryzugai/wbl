        ...
        <div class="main-content">
          ...
          <div class="section">
            ...
            <div class="about-text">
              ${about || (lang === 'ms' ? 'Pelajar yang berdedikasi dari Fakulti Pengurusan Teknologi dan Teknousahawanan (FPTT), UTeM.' : 'Dedicated student from the Faculty of Technology Management and Technopreneurship (FPTT), UTeM.')}
            </div>
          </div>
          ...
          <div class="section">
            ...
            `).join('') : `
              <div class="item-row">
                ...
                <div class="item-desc">${lang === 'ms' ? 'Menjalani latihan industri berstruktur selama 52 minggu di industri untuk mengaplikasikan kemahiran teknousahawanan.' : 'Undergoing a structured 52-week industrial training in the industry to apply technopreneurship skills.'}</div>
              </div>
            `}
          </div>
          ...
          <div class="ref-section">
            ...
            <div class="ref-card">
              ...
              <div>${t.faculty}</div>
              <div>${lang === 'ms' ? 'Emel' : 'Email'}: guzairy@utem.edu.my | Tel: 06-2708134</div>
            </div>
          </div>
